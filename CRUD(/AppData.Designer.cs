...
namespace CRUD_.AppDataTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employees` SET `FullName` = ?, `PhoneNumber` = ?, `Email` = ?, `Address` = ?, `Image` = ? WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_.Properties.Settings.Default.Mydb2003ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, FullName, PhoneNumber, Email, Address, [Image] FROM Employees";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_FullName, string Original_PhoneNumber, string Original_Email, string Original_Address) {
        ...
        public virtual int Update(string FullName, string PhoneNumber, string Email, string Address, byte[] Image, int Original_EmployeeID, string Original_FullName, string Original_PhoneNumber, string Original_Email, string Original_Address) {
            if ((FullName == null)) {
